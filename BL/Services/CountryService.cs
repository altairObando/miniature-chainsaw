...
{
    internal class CountryService : IServices
    {
        private readonly DAL.Context _cntx;
        private readonly CatalogRepository<Country> _repo;
        private readonly IDbConnection _conn;
        public IServiceRequest Request { get; set; }
        public CountryService(IServiceRequest request, Context context, IDbConnection connection, string name)
        {

            _conn = connection;
            _cntx = context;
            _repo = new CatalogRepository<Country>(_cntx, _conn, name);
            Request = request;
        ...
        public void AddResult(IEnumerable<Country> data)
        {
